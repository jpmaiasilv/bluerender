...
/** Cost shown here always comes from the real duration × credits-per-second rate returned by the backend — never a hardcoded number. */
export function VideoCreditGenerationButton({
  totalCost,
  walletBalance,
  walletLoaded,
  canAfford,
  ...
  return (
    <div className="flex flex-col items-end gap-1.5">
      ...
      >
        {isGenerating ? t.generating : t.generateButton(totalCost)}
      </button>
