...
const STAGE_TO_STEP_KEY: Record<JobStage, keyof ReturnType<typeof useLanguage>['messages']['ideaGenerator']['loadingStatus']['steps']> = {
  uploading: 'preparing',
  sending: 'exploring',
  rendering: 'creating',
...
export function IdeaLoadingStatus({ stage }: Props) {
  const { messages } = useLanguage();
  const t = messages.ideaGenerator.loadingStatus;
